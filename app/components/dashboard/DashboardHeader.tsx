...
export default function DashboardHeader() {
    return (
        <Paper elevation={1} component={Box} display="flex" justifyContent="space-between" alignItems="center" p={3} bgcolor="#fff" borderRadius={2}>
            <Box>
                <Typography variant="h6" color="primary">Good Morning, Maruf!</Typography>
